lu = require("luaunit")
package.path = package.path .. ";../?.lua;../util/?.lua;../geometry/?.lua;../courseGenerator/?.lua;../courseGenerator/geometry/?.lua"
...
function testIsWithinDistanceToPolygon()
    local polygon = {
        { x = -10, z = - 10 },
        { x = 10, z = - 10 },
        { x = 10, z = 10 },
    ...
    lu.assertIsTrue(CpMathUtil.isWithinDistanceToPolygon(polygon, 11, 11, 2))
    lu.assertIsTrue(CpMathUtil.isWithinDistanceToPolygon(polygon, -11, 11, 2))
    lu.assertIsTrue(CpMathUtil.isWithinDistanceToPolygon(polygon, -11, -11, 2))
    lu.assertIsTrue(CpMathUtil.isWithinDistanceToPolygon(polygon, 11, -11, 2))
    lu.assertIsTrue(CpMathUtil.isWithinDistanceToPolygon(polygon, 9, 9, 2))
    lu.assertIsTrue(CpMathUtil.isWithinDistanceToPolygon(polygon, 12, 12, 2))
    lu.assertIsFalse(CpMathUtil.isWithinDistanceToPolygon(polygon, 12.1, 12, 2))
    lu.assertIsFalse(CpMathUtil.isWithinDistanceToPolygon(polygon, -12.1, 12, 2))
    lu.assertIsFalse(CpMathUtil.isWithinDistanceToPolygon(polygon, -12.1, -12, 2))

    lu.assertIsFalse(CpMathUtil.isWithinDistanceToPolygon(polygon, 15, 12, 2))
end
